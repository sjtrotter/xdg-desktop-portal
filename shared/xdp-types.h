...
#define CERTIFICATE_EXPERIMENTAL_DBUS_IFACE DESKTOP_EXPERIMENTAL_DBUS_IFACE ".Certificate"
#define CERTIFICATE_EXPERIMENTAL_DBUS_IMPL_IFACE DESKTOP_EXPERIMENTAL_DBUS_IMPL_IFACE ".Certificate"
#define CERTIFICATE_EXPERIMENTAL_NAME "certificate"
#define CERTIFICATE_PERMISSION_TABLE "certificate"
